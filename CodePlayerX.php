<?php
	...
	if(isset($_SESSION['id'])) {
		header('Location: CodePlayerMember.php');
	}
...
<html lang="en">
  ...
  <body>
	...
	<!-- Login Modal -->
<div class="modal fade" id="loginModal" tabindex="2" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <div class="modal-footer">
        Don't have an account? <a href="#" data-toggle="modal" data-target="#registerModal">Sign Up here</a>
      </div>
...
<div id="main"> 
	...
	<div id="tabs" class="ui-widget-content container-fluid">
				...
				<div id="tabHTML" >
					<h4>HTML</h4>
					<textarea id="html" placeholder="HTML code goes here..."></textarea>
				</div>
					
					
				<div id="tabCSS" >
					<h4>CSS</h4>
					<textarea id="css" placeholder="CSS code goes here..."></textarea>
				</div>
